...
| P5 RTE generator | done — **M1 met** | CI: 12 generator tests + generated firmware built and run on emulated RP2040 (ASW↔ASW round trip closes) | array signals (ERT step code now wired in — see docs/PROBLEM_INVENTORY.md C-7) |
